<%@ Page Title="Accountability - View" Language="vb"
    AutoEventWireup="false"
    CodeBehind="ViewAccountability.aspx.vb"
    Inherits="InventorySystem.ViewAccountability"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Accountability - View</title>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="w3-container" style="margin-left: 40px; margin-right: 40px; margin-top: 80px; overflow: auto">
        <div class="w3-card-4 w3-round-small w3-white" style="margin-top: 4px; margin-bottom: 4px;">
            <div runat="server" id="dvView" visible="false">
                <div class="w3-row">
                    <%--<div class="w3-card-4 w3-round-small w3-white" style="margin-top: 4px;">--%>
                    <div class="w3-row w3-padding">
                        ...
                        <div class="w3-row" style="margin-top: 5px; margin-bottom: 5px;">
                            <div class="w3-third" style="padding: 4px 4px 4px 4px;">
                                <asp:Label CssClass="labelSytle" runat="server" Text="Assigned To : "></asp:Label>
                            ...
                            <div class="w3-third" style="padding: 4px 4px 4px 4px;">
                                <asp:Label CssClass="labelSytle" runat="server" Text="Assign Date : "></asp:Label>
                                <asp:TextBox runat="server" ID="txtAssignDate" CssClass="w3-input w3-border textboxStyle"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="w3-row" style="border-bottom: 1px solid #EEEEEE; margin-top: 4px; margin-bottom: 10px;">
                            <div class="w3-quarter" style="padding: 4px 4px 4px 4px;">
                                ...
                                <asp:TextBox runat="server" ID="txtItemOS" CssClass="w3-input w3-border textboxStyle"></asp:TextBox>
                            </div>
                            <div class="w3-quarter" style="padding: 4px 4px 4px 4px;">
                                ...
                                <%--<editable:EditableDropDownList Width="93%" runat="server" ID="ddlDepartment" CssClass="w3-input w3-border textboxStyle"></editable:EditableDropDownList>--%>
                            </div>
                            <div class="w3-quarter" style="padding: 4px 4px 4px 4px;">
                ...
                <div class="w3-row">
                    <div runat="server" id="dvGVadditional" visible="false" style="margin-bottom: 4px;">
                        <div class="w3-row w3-padding">
                            <div class="w3-col s12 w3-padding-left" style="border-bottom: 1px solid #EEEEEE">
                            ...
                            <div class="w3-third" style="padding: 4px 4px 4px 4px;">
                                ...
                                <editable:EditableDropDownList Width="93%" runat="server" ID="ddlType2" AutoPostBack="true" OnSelectedIndexChanged="ddlType2_SelectedIndexChanged" CssClass="w3-input w3-border textboxStyle">
                                </editable:EditableDropDownList>
                            </div>
                            <div class="w3-third" style="padding: 4px 4px 4px 4px;">
                                <asp:Label runat="server" Text="Description" CssClass="labelSytle"></asp:Label>
                                <editable:EditableDropDownList Width="93%" runat="server" ID="ddlDesc2" AutoPostBack="true" OnSelectedIndexChanged="ddlDesc2_SelectedIndexChanged" CssClass="w3-input w3-border textboxStyle">
                                </editable:EditableDropDownList>
                            </div>
                            <div class="w3-third" style="padding: 4px 4px 4px 4px;">
            ...
            <div runat="server" id="dvMain" visible=" true ">
                <div class="w3-row w3-padding">
                    <div class="w3-left">
                ...
                <div class="w3-row w3-padding">
                    <div class="w3-third" style="padding: 2px 2px 2px 2px">
                        <asp:Label CssClass="labelSytle" runat="server" Text="Employee Name : "></asp:Label>
                        <asp:TextBox runat="server" ID="txtName" CssClass="w3-input w3-border textboxStyle"></asp:TextBox>
                    </div>
                    <div class="w3-half" style="padding: 2px 2px 2px 2px; width: 66%">
                        <asp:Label CssClass="labelSytle" runat="server" Text="Remarks : "></asp:Label>
                        <asp:TextBox runat="server" ID="txtRemarks" CssClass="w3-input w3-border textboxStyle"></asp:TextBox>
                    </div>
                </div>
                <div class="w3-row w3-padding">
                    <asp:Panel ID="Panel1" runat="server">
                        <asp:GridView runat="server" ID="gvView" OnRowDataBound="gvView_RowDataBound"
                            OnSelectedIndexChanged="gvView_SelectedIndexChanged" BorderStyle="None" GridLines="Horizontal" Width="100%">
                            <RowStyle CssClass="RowStyle" />
    ...
    <%-- <div class="w3-container">
        <asp:Panel ID="Panel1" runat="server" Visible="false">
            <asp:GridView runat="server" ID="GridView1" AutoGenerateColumns="true" BorderStyle="None" GridLines="Horizontal" Width="100%">
                <RowStyle CssClass="RowStyle" />
                <HeaderStyle BackColor="#1e8cdb" CssClass="l9" ForeColor="White" />
                <EmptyDataTemplate>
                    <div style="text-align: center;">
